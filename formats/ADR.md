...
`brain/knowledge/ADR.md`. Every hard-to-reverse call the project has made, **newest first**, so the top of
...
**Grep the file first.** If a decision on this subject already exists, you are either revising it (edit it)
...
- **What something currently is** — that is `brain/knowledge/context.md`. ADRs are history and reasoning.
